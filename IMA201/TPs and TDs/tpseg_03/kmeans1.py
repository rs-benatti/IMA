...
ima=imread("C:\\Users\\User\\Documents\\Estudos\\Télécom Paris\\IMA\\tpseg\\cell.tif")
...
image_array_sample = shuffle(image_array, random_state=randNumber)[:1000]
kmeans = KMeans(n_clusters=n_class, random_state=randNumber).fit(image_array_sample)
